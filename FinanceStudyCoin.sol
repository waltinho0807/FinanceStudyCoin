...
contract FixedSupplyToken is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "FST";
        name = "Finance Study Test";
        decimals = 18;
        amount_eth = 0;
        token_price = 10; //Aqui eu estipulo quantos tokens eu compro com 1 ETH, Não entendi o porque disto?
        sellPrice = token_price + token_price * 20/100;
        _totalSupply = 100000 * 10**uint(decimals);
        balances[owner] = _totalSupply * 5/100;
        balances[address(this)] = _totalSupply * 95/100;
    ...
    // ------------------------------------------------------------------------
    // Função para conversão da token
    // ------------------------------------------------------------------------
...
contract FinanceStudy is ERC20Interface, Owned {
